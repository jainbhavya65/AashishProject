...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Flash Store!</h1>
                    <p>We have the best cameras, watches and phones for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/redmi5.jpg" alt="redmi">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Redmi note 5</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/vivov5.jpg" alt="vivo">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Vivo v5</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/oneplus6t.jpg" alt="1+">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>oneplus 6T</h3>
                                    <p>Price: Rs. 31200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
